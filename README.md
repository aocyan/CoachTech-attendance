...
<p>&nbsp;&nbsp;&nbsp;&nbsp;ubuntu内PHPコンテナ上で<br>
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;ubuntuのPHPコンテナ上で　php artisan db:seed --class=AdminSeeder　を実行するとデータベースに挿入することができ<br>
   &nbsp;&nbsp;&nbsp;&nbsp;管理者ログインすることができます。</p>
<h3>14.テストケースの実行</h3>
...
<p>ⅲ）&nbsp;&nbsp;&nbsp;&nbsp;出勤中　→　勤務中　に文言変更</p>
<p>ⅳ）&nbsp;&nbsp;&nbsp;&nbsp;「退勤」ボタンを「退勤する」ボタンにボタン名を変更</p>
<p>ⅴ）&nbsp;&nbsp;&nbsp;&nbsp;「休憩入」ボタンを「休憩する」ボタンにボタン名を変更</p>
<p>ⅵ）&nbsp;&nbsp;&nbsp;&nbsp;「休憩戻」ボタンを「休憩終わり」ボタンにボタン名を変更</p>
<p>ⅶ）&nbsp;&nbsp;&nbsp;&nbsp;お疲れ様でした。　→　一日お疲れさまでした　に文言変更</p>
<p>ⅷ）&nbsp;&nbsp;&nbsp;&nbsp;画面下部に「ログアウトする」ボタンを追加（ユーザはログアウトすることができる）</p>
<h4>・勤怠一覧画面について</h4>
